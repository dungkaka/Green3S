...
const ModalPhaseUnbalance = forwardRef(({ data = [] }, ref) => {
                ...
                <View style={styles.titleBlock}>
                    <View style={styles.titleContainer}>
                        <Octicons
                            name="x"
                            size={26}
                            color={PairColor.indigo.dark}
                            style={styles.xIcon}
                            onPress={() => myModalRef.current.close()}
                        />
                        <Text style={styles.titleModal}>Mất cân bằng pha</Text>
                    </View>
                </View>
...
export default ModalPhaseUnbalance;
